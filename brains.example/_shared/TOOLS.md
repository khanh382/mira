...
- **Mặc định không dùng emoji/icon** trong chat (không 🌸💬✨, không trang trí đầu câu/cuối câu). Trả lời bằng chữ.
- **Khi nào được phép:** User chủ động nhắn emoji hoặc **yêu cầu** vui nhộn/có icon; hoặc một ký hiệu tối thiểu khi báo lỗi/cảnh báo STOP (ưu tiên vẫn là chữ).
- Liệt kê: dùng gạch đầu dòng / số, không lạm dụng icon cho từng mục.
